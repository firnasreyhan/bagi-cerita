<?php
   include('session.php');
	...
	$result = mysqli_query($mysqli, "SELECT * FROM cerita WHERE EMAIL='$email'");
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php  
									while($cerita = mysqli_fetch_array($result)) {         
										...
										echo "<td><a type='button' class='btn btn-primary btn-xs' href=tables_subcerita.php?ID_CERITA=".$cerita['ID_CERITA'].">Detail</a> | <a type='button' class='btn btn-warning btn-xs' href=forms_edit.php?ID_CERITA=".$cerita['ID_CERITA'].">Edit</a> | <a type='button' class='btn btn-danger btn-xs' href=delete.php?ID_CERITA=".$cerita['ID_CERITA'].">Hapus</a>";
										echo "</tr>";			
									}
								?>	
                                </tbody>
